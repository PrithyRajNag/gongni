                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-9 ">
                                            ...
                                            <div class="form-group row">
                                                <label id="emergency_contact" class="col-sm-6 col-md-3  col-form-label">{{__('Emergency Contact')}} :</label>
                                                <div class="col-sm-6 col-md-9  pt-2">
                                            ...
                                            <div class="form-group row">
                                                <label id="designation" class="col-sm-6 col-md-3  col-form-label">{{__('Designation')}} :</label>
                                                <div class="col-sm-6 col-md-9  pt-2">
                                                    {{ ucfirst($data->designation) }}
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label id="job_type" class="col-sm-6 col-md-3  col-form-label">{{__('Job Type')}} :</label>
                                                <div class="col-sm-6 col-md-9  pt-2">
                                            ...
                                            <div class="form-group row">
                                                <label id="join_date" class="col-sm-6 col-md-3  col-form-label">{{__('Join Date')}} :</label>
                                                <div class="col-sm-6 col-md-9  pt-2">
