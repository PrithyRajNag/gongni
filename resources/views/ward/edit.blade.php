                            ...
                            <form role="form" id="editForm" action="{{route('ward.update', $data->slug)}}" class="form-horizontal clearfix"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="name" class="col-sm-3 col-form-label">{{__('Ward Name')}}</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="number" class="col-sm-3 col-form-label">{{__('Ward Number')}}</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="area" class="col-sm-3 col-form-label">{{__('Ward Area')}}</label>
                                        <div class="col-sm-6">
