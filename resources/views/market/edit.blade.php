                            ...
                            <form role="form" id="editForm" action="{{route('market.update', $data->slug)}}"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="name" class="col-sm-3 col-form-label">{{__('Market Name')}}</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="number"
                                               class="col-sm-3 col-form-label">{{__('Market Number')}}</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="area" class="col-sm-3 col-form-label">{{__('Market Area')}}</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="total_shop"
                                               class="col-sm-3 col-form-label">{{__('Total Shop')}}</label>
                                        <div class="col-sm-6">
